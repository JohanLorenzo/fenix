...
SIGNING_ROUTE_TEMPLATES = [
    "index.project.{trust-domain}.{repo_name}.v2.{variant}.{build_date}.revision.{head_rev}",
    "index.project.{trust-domain}.{repo_name}.v2.{variant}.{build_date}.latest",
    "index.project.{trust-domain}.{repo_name}.v2.{variant}.latest",
]
...
def add_signing_indexes(config, task):
    ...
    subs["repo_name"] = config.params["project"].split("/")[-1]
